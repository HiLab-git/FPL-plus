...
def evaluation_1(config):
    ...
    if(not(isinstance(seg_root, tuple) or isinstance(seg_root, list))):
        seg_root = [seg_root]
    test_image_pair_csv = config['test_evaluation_image_pair']
    valid_image_pair_csv = config['valid_evaluation_image_pair']
